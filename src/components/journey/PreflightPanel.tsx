    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between gap-3">
          ...
          <span className="rounded-full border border-[rgba(255,185,84,0.28)] bg-[rgba(255,185,84,0.08)] px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-[0.18em] text-[color:var(--text-on-warm-strong)]">
            +3 XP
          </span>
        </div>
